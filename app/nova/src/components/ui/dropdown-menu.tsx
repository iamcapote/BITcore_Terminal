/**
 * @license INTERNAL ONLY — Dropdown menu primitive
 *
 * Why: Provide accessible contextual actions that align with Nova's design system.
 * What: Thin wrappers around Radix dropdown menu components with Tailwind styling helpers.
 * How: Forward refs through each sub-component and merge class names via cn utility.
 */
...
const DropdownMenuShortcut = ({ className, ...props }: React.HTMLAttributes<HTMLSpanElement>) => {
  return <span className={cn("ml-auto text-xs tracking-[0.2em] text-muted-foreground", className)} {...props} />;
};
