/**
 * @license INTERNAL ONLY — Card primitive
 *
 * Why: Provide structural containers for panels, decks, and inspector surfaces.
 * What: Semantic article wrapper with optional header, content, footer, and description slots.
 * How: Export utility components that compose Tailwind classes while remaining skin-agnostic.
 */
